  ...
  ?>
          ...
          <div class="col-md-9">
              <div class="box">
                  <h1>Shop</h1>
                  <p>
                  Barkadeer rigging swab rum capstan lateen sail killick keelhaul coffer Arr. Scuttle Gold Road row's nest square-rigged smartly Jolly Roger chandler galleon loot marooned Chain Shot main sheet. 
                  </p>
              </div>
              <!-- Shop-Product Begin -->
              <div class="row">
